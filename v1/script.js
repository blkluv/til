...
async function loadFacts() {
  const res = await fetch(
    'https://jixkwpgwbrzsliyprmje.supabase.co',
    {
      headers: {
        apikey:
        ...
        authorization:
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..jQvU3eFuKaPpidcpBTXWGn8jYYLmCTpmtUXwqhpZeYI',
      },
    }
  );
  const data = await res.json();
  // console.log(data);
  const filteredData = data.filter((fact) => fact.category === 'facts');
